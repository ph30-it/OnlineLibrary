...
<script src="{{ asset('assets_admin/js/raphael.min.js') }}"></script>
<script src="{{ asset('assets_admin/js/morris.min.js') }}"></script>
<script src="{{ asset('assets_admin/js/morris-data.js') }}"></script>
@endsection