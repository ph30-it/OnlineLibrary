...
@section('custom-css')
<link rel="stylesheet" type="text/css" href="{{URL::asset('css/Category/category_page.css')}}">
@endsection
...
@section('custom-js')
<script type="text/javascript" src="{{URL::asset('js/Category/category_page.js')}}"></script>
@endsection
